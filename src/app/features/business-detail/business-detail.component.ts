        ...
        <div class="card p-6 mb-6">
          <div class="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
            <div class="flex-1">
              <div class="flex items-center mb-2">
                <h1 class="text-3xl font-bold text-gray-900 mr-3">{{ business.name }}</h1>
                <span *ngIf="business.verified" 
                      class="bg-primary-600 text-white px-3 py-1 rounded text-sm font-semibold">
                  ✓ Verified
                </span>
              </div>
          ...
          <div class="flex flex-col sm:flex-row gap-4 mb-6">
            ...
            <a 
              *ngIf="business.whatsapp"
              ...
              target="_blank"
              class="btn-secondary flex items-center justify-center bg-green-600 text-white border-green-600 hover:bg-green-700">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              ...
              <p class="text-gray-600 mt-1">{{ business.area }}, Lagos</p>
            </div>

            <!-- Phone -->
            <div>
              <h3 class="text-lg font-semibold text-gray-900 mb-2">📞 Phone</h3>
              <a [href]="'tel:' + business.phone" class="text-primary-600 hover:text-primary-700">
                {{ business.phone }}
              </a>
            </div>
          </div>
